...
<body class="">
    <div class="main-wrapper" style= "background: aqua";>
                                    ...
                                    <div class="col-md-11">
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title text-center">
                                                    <h4 style="    background: chartreuse";> Admin Login</h4>
                                                </div>
                                            </div>
                                            <div class="panel-body p-20">
                                        ...
                                        <!-- /.panel -->
                                        <p class="text-muted text-center"><small>Copyright © Student Result Management System</small></p>
                                    </div>
                                    <!-- /.col-md-11 -->
                                </div>
                                <!-- /.row -->
